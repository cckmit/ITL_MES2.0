...
/**
 * DTO类-ImSession类（iap_im_session_t）
 *
 * @author tanq
 * @date 2020-10-10
 * @since jdk1.8
 */
public class IapImSessionDto implements Serializable {
	...
	public IapImSessionDto(Channel session) {
		this.session = session;
		this.nid = session.id().asShortText();
	}


	public IapImSessionDto() {
	...
	public boolean equals(Object o) {
		if (o instanceof IapImSessionDto) {
			IapImSessionDto target = (IapImSessionDto) o;
	...
	public static IapImSessionDto decode(byte[] protobufBody) throws InvalidProtocolBufferException {
		if(protobufBody == null) {
			return null;
		}
		SessionProto.Model proto = SessionProto.Model.parseFrom(protobufBody);
		IapImSessionDto session = new IapImSessionDto();
