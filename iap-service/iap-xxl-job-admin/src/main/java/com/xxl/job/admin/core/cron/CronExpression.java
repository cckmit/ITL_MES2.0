...
public final class CronExpression implements Serializable, Cloneable {
    ...
    protected void buildExpression(String expression) throws ParseException {
        ...
        try {
            ...
            boolean dayOfMonthSpec = !dom.contains(NO_SPEC);
            boolean dayOfWeekpec = !dow.contains(NO_SPEC);

            if (!dayOfMonthSpec || dayOfWeekpec) {
                if (!dayOfWeekpec || dayOfMonthSpec) {
    ...
    public Date getTimeAfter(Date afterTime) {
        ...
        while (!gotOne) {
            ...
            // get day...................................................
            boolean dayOfMonthSpec = !daysOfMonth.contains(NO_SPEC);
            boolean dayOfWeekSpec = !daysOfWeek.contains(NO_SPEC);
            if (dayOfMonthSpec && !dayOfWeekSpec) { // get day by day of month rule
            ...
            } else if (dayOfWeekSpec && !dayOfMonthSpec) { // get day by day of week rule
